						...
						<form action="/groupInformation/${user.userId }" method="POST">
							<div class="container">
								<label><b>Group Name*: </b></label> <input type="text"
									placeholder="Group Name" name="groupName" required> <label><b>GROUP
										DESCRIPTION*: </b></label> <input type="text" width="22%"
									placeholder="About" name="about" required>

								<div class="clearfix">
									<button type="submit" class="signupbtn">Create</button>

									<button class="button">
										<a href="/profile"><font color=" #ffffff"> Cancel
										</font></a>
									</button>
								</div>
