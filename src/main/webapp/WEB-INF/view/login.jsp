...
<div id="page">
  ...
  <header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(1.jpg);">
        ...
        <div class="col-md-8 col-md-offset-2 text-center">
          <div class="display-t">
            <div class="display-tc animate-box" data-animate-effect="fadeIn">
              ...
              <h2><font color="#FF0080">Networking for student organizations redefined</font></h2>
              <p><a href="signup.html" class="btn btn-default">Sign up</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <div class="feature-center animate-box" data-animate-effect="fadeIn">
            ...
            <p>Got a student organization? Or just a close group of friends? Take the pilot's seat by launching and managing your own club. Your new contacts will thank you for your initiative</p>
            <p><a href="#" class="btn btn-primary">Learn More</a></p>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="feature-center animate-box" data-animate-effect="fadeIn">
            ...
            <p>Connect with your club members through comments, file sharing, chatting, messaging, and fun</p>
            <p><a href="#" class="btn btn-primary">Learn More</a></p>
          </div>
        </div>
      </div>
